            ...
            <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row py-10'>
                <div className='w-full md:w-1/2  order-2 md:order-1 '>
                    <div className='space-y-12 mt-12 md:mt-32 '>
                        ...
                        <p className='text-xl'>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. At cumque praesentium asperiores quasi. Laudantium nemo ea mollitia sequi quae illum.
                        </p>
                ...
                <div className='w-full md:w-1/2 order-1 '>
                    <img src={Banner1} className='w-92 h-92' alt="" />
                </div>
            </div>
        </>
    )
